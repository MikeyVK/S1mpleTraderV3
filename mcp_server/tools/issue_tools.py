...
class CreateIssueTool(BaseTool):
    ...
    async def execute(self, params: CreateIssueInput, _context: NoteContext | None = None) -> ToolResult:
        try:
...
class GetIssueTool(BaseTool):
    ...
    async def execute(self, params: GetIssueInput, _context: NoteContext | None = None) -> ToolResult:
        try:
...
class ListIssuesTool(BaseTool):
    ...
    async def execute(self, params: ListIssuesInput, _context: NoteContext | None = None) -> ToolResult:
        try:
...
class UpdateIssueTool(BaseTool):
    ...
    async def execute(self, params: UpdateIssueInput, _context: NoteContext | None = None) -> ToolResult:
        try:
...
class CloseIssueTool(BaseTool):
    ...
    async def execute(self, params: CloseIssueInput, _context: NoteContext | None = None) -> ToolResult:
        try:
