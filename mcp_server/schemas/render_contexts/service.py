# mcp_server/schemas/render_contexts/service.py
# template=schema version=74378193 created=2026-02-17T00:00Z updated=
"""ServiceRenderContext schema.

System-enriched context with lifecycle fields for service_command
...
class ServiceRenderContext(BaseRenderContext, ServiceContext):
    ...
    via _enrich_context transformation: ServiceContext + lifecycle fields.
    Templates receive this schema for rendering.

    Inherits:
        - name, description, layer, responsibilities, parameters, return_type (from ServiceContext)
