...
# CRITICAL: Force UTF-8 on Windows stdout/stderr (prevents charmap codec errors)
        ...
        while self.server_process:
            try:
                ...
                if RESTART_MARKER in line:
                    self.log("ðŸ”„ Restart marker detected on stderr - initiating transparent restart",
            ...
            for line in sys.stdin:
                ...
                try:
                    ...
                    if message.get("method") == "initialize":
                        ...
                        protocol_version = message.get("params", {}).get("protocolVersion", "unknown")
                        
                        self.log(f"Initialize request captured (id={init_id}, client={client_name}, protocol={protocol_version})",
