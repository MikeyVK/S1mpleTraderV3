...
class ArtifactManager:
    ...
    def _prepare_scaffold_metadata(
        ...
        """Prepare metadata for scaffolding (version_hash, timestamp, tier_chain).
        ...
        Returns:
            Tuple of (version_hash, timestamp, tier_chain)
        """
        ...
        # Note: timestamp is generated by template_scaffolder (centralized)
        return version_hash, None, tier_chain
    ...
    async def scaffold_artifact(
        ...
        **context: Any
        ...
        # Task 1.1c: Prepare metadata (version_hash, timestamp, tier_chain)
        version_hash, timestamp, tier_chain = self._prepare_scaffold_metadata(
