...
from mcp_server.adapters.git import GitAdapter
...
class GitManager:
    ...
    def create_feature_branch(self, name: str, type: str = "feature") -> str:
        """Create a new feature branch enforcing naming conventions."""
        # Validation
        if type not in ["feature", "fix", "refactor", "docs"]:
            raise ValidationError(
                f"Invalid branch type: {type}",
