...
class TestOriginCreation:
    ...
    def test_create_tick_origin(self):
        ...
        origin = Origin(id="TCK_20251109_143022_abc123", type=OriginType.TICK)
    ...
    def test_create_news_origin(self):
        ...
        origin = Origin(id="NWS_20251109_143022_def456", type=OriginType.NEWS)
    ...
    def test_create_schedule_origin(self):
        ...
        origin = Origin(id="SCH_20251109_143022_ghi789", type=OriginType.SCHEDULE)
...
class TestOriginEquality:
    ...
    def test_origins_with_same_values_are_equal(self):
        ...
        origin1 = Origin(id="TCK_20251109_143022_abc123", type=OriginType.TICK)
        origin2 = Origin(id="TCK_20251109_143022_abc123", type=OriginType.TICK)
    ...
    def test_origins_with_different_ids_are_not_equal(self):
        ...
        origin1 = Origin(id="TCK_20251109_143022_abc123", type=OriginType.TICK)
        origin2 = Origin(id="TCK_20251109_143022_xyz789", type=OriginType.TICK)
        assert origin1 != origin2

    def test_origins_with_different_types_are_not_equal(self):
        """Test that Origin instances with different types are not equal."""
        origin1 = Origin(id="TCK_20251109_143022_abc123", type=OriginType.TICK)
        origin2 = Origin(id="NWS_20251109_143022_abc123", type=OriginType.NEWS)
        assert origin1 != origin2
