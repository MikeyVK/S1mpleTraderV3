...
class TestTemplateEngineInitialization:
    ...
    def test_accepts_template_root_parameter(self):
    ...
    def test_raises_on_nonexistent_root(self):
...
class TestTemplateEngineRendering:
    ...
    def test_renders_simple_template(self, engine):
    ...
    def test_raises_on_missing_template(self, engine):
...
class TestTemplateEngineInheritance:
    ...
    def test_supports_extends_chain(self, engine):
...
class TestTemplateEngineCustomFilters:
    ...
    def test_pascalcase_filter(self, engine):
    ...
    def test_snakecase_filter(self, engine):
    ...
    def test_validate_identifier_filter(self, engine):
        ...
        with pytest.raises(Exception):  # Jinja2 will wrap the ValueError
...
class TestTemplateEngineErrorHandling:
    ...
    def test_template_not_found_message(self, engine):
