...
def test_create_label_exists(adapter):
    adapter.client.get_repo.return_value.create_label.side_effect = GithubException(422, "Validation Failed")
...
def test_create_issue_milestone_not_found(adapter):
    adapter.client.get_repo.return_value.get_milestone.side_effect = GithubException(404, "Not Found")
...
def test_create_milestone_error(adapter):
    adapter.client.get_repo.return_value.create_milestone.side_effect = GithubException(500, "Error")
