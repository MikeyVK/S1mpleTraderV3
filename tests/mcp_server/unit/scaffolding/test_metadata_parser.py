...
class TestScaffoldMetadataParser:
    ...
    def test_parse_python_hash_comment(self) -> None:
    ...
    def test_parse_typescript_double_slash_comment(self) -> None:
    ...
    def test_parse_markdown_html_comment(self) -> None:
    ...
    def test_parse_jinja2_comment(self) -> None:
    ...
    def test_parse_with_optional_updated_field(self) -> None:
    ...
    def test_parse_ephemeral_artifact_without_path(self) -> None:
    ...
    def test_parse_non_scaffolded_file_returns_none(self) -> None:
...
"""
    ...
    def test_parse_scaffold_not_on_first_line_returns_none(self) -> None:
...
"""
    ...
    def test_parse_missing_required_field_raises_error(self) -> None:
...
"""
    ...
    def test_parse_invalid_field_format_raises_error(self) -> None:
    ...
    def test_parse_invalid_timestamp_format_raises_error(self) -> None:
...
"""
    ...
    def test_parse_unknown_extension_returns_none(self) -> None:
...
"""
    ...
    def test_parse_malformed_key_value_raises_error(self) -> None:
    ...
    def test_parse_case_sensitive_field_names(self) -> None:
    ...
    def test_parse_duplicate_fields_uses_last_value(self) -> None:
    ...
    def test_parse_unknown_fields_are_ignored(self) -> None:
        """RED: Unknown fields should be silently ignored (2-line format)."""
        content = (
            "# test.py\n"
            "# template=dto version=abc12345 created=2026-01-20T14:00Z "
            "updated= unknown_field=ignored\n"
        )
        parser = make_metadata_parser()
        metadata = parser.parse(content, ".py")
        assert metadata is not None
