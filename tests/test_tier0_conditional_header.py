...
class TestTier0ConditionalHeader:
    ...
    def test_none_output_path_renders_compact_header(self, tier0):
    ...
    def test_empty_output_path_renders_compact_header(self, tier0):
    ...
    def test_compact_header_has_no_created_or_updated(self, tier0):
    ...
    def test_compact_header_has_no_empty_filepath_comment(self, tier0):
    ...
    def test_non_empty_output_path_renders_two_line_markdown(self, tier0):
    ...
    def test_non_empty_output_path_renders_two_line_python(self, tier0):
