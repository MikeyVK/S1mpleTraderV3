# tests\copilot_orchestration\unit\hooks\test_session_start_qa.py
# template=unit_test version=3d15d309 created=2026-03-22T21:30Z updated=
"""
Unit tests for copilot_orchestration.hooks.session_start_qa.
...
@layer: Tests (Unit)
@dependencies: [pytest, copilot_orchestration.hooks.session_start_qa]
@responsibilities:
...
# Project modules
from copilot_orchestration.hooks.session_start_qa import is_usable_snapshot

_LOGGER_NAME = "copilot_orchestration.hooks.session_start_qa"
