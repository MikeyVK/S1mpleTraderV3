...
class TestLoggingConfig:
    ...
    def test_loads_project_yaml_when_present(self, tmp_path: Path) -> None:
        ...
        assert cfg._level == "DEBUG"  # noqa: SLF001
    ...
    def test_apply_creates_log_directory(self, tmp_path: Path) -> None:
        """apply() creates the .copilot/logs/ directory tree if it does not exist."""
        cfg = LoggingConfig.from_copilot_dir(tmp_path)
    ...
    def test_apply_idempotent_when_dir_exists(self, tmp_path: Path) -> None:
