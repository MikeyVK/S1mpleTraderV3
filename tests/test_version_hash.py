...
class TestComputeVersionHashNoPlaceholders:
    ...
    def test_hash_does_not_use_placeholder_concrete_string(self):
        ...
        tier_chain_v1 = tier_chain + [("dto.py", "1.0.0")]
        tier_chain_v2 = tier_chain + [("dto.py", "2.0.0")]
    ...
    def test_hash_changes_when_concrete_template_version_changes(self):
        ...
        tier_chain_v1 = tier_chain_base + [("dto.py", "1.0.0")]
        tier_chain_v2 = tier_chain_base + [("dto.py", "2.0.0")]
        ...
        try:
            assert hash_v1 != hash_v2
            assert False, "Unexpected: hash changed without version info (bug fixed?)"
