...
| 2.1 | 2025-12-07 | AI Agent | Moved ExecutionCommandBatch to separate design doc |

---

## Related Documents

- [EXECUTION_COMMAND_BATCH_DESIGN.md](EXECUTION_COMMAND_BATCH_DESIGN.md) - ExecutionCommandBatch design (same file, separate DTO)
