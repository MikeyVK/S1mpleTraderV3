...
Work continuity risk between machines may cause context loss, duplicated effort, and missed QA checkpoints.

## Research Goals

- Preserve actionable session context
- Enable quick restart on another machine
